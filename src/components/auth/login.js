...
{/* ------------------------------------------formulario------------------------------------------- */}
          ...
          <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md z-10 opacity-80">
            ...
            <h2 className="my-6 text-center text-3xl font-extrabold text-gray-900">Iniciar Sesión</h2>
          </div>
              
              <form  onSubmit={(e)=> onSubmit(e)} className="opacity-100 space-y-6" action="#" method="POST">
                <div>
                  <label htmlFor="email" className=" block text-sm font-medium font-bold text-gray-900 ">
                    Email address
                  </label>
                  <div className="mt-1">
                    <input
                ...
                <div>
                  <label htmlFor="password" className="block text-sm font-medium font-bold  text-gray-900">
                    Password
                  </label>
                  <div className="mt-1">
                    <input
